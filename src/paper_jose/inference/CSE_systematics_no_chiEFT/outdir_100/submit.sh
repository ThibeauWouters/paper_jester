...
#SBATCH --output="./CSE_systematics_no_chiEFT/outdir_100/log.out"
#SBATCH --job-name="100"
...
# Run the script
python inference.py \
    --outdir ./CSE_systematics_no_chiEFT/outdir_100/ \
    --nb-cse 100 \
...
python postprocessing.py ./CSE_systematics/outdir_100/
