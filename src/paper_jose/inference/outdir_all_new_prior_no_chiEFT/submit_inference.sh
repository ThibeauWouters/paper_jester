...
#SBATCH --output="./outdir_all_new_prior_no_chiEFT/log.out"
#SBATCH --job-name="all_new_prior_no_chiEFT"
...
# Run the script
python inference.py \
    --outdir ./outdir_all_new_prior_no_chiEFT/ \
...
python postprocessing.py outdir_all_new_prior_no_chiEFT
