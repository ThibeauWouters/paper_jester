...
class UniversalRelationsScoreFn:
    ...
    def __init__(self,
                 ...
                 random_samples_outdir: str = "../benchmarks/random_samples_MTOV_15/",
        ...
        print(f"Going to use the set of random samples at {random_samples_outdir} for optimization")
...
def assess_binary_love_accuracy(outdir_list: list[str] = ["../benchmarks/random_samples/", "../doppelgangers/outdir/"],
